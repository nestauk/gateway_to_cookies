.PHONY: git pipeline all clean data lint requirements sync_data_to_s3 sync_data_from_s3
...
PROFILE = default
PROJECT_NAME = gateway_to_cookies
...
## Make Dataset
data: requirements
	$(PYTHON_INTERPRETER) gateway_to_cookies/data/make_dataset.py
